<template>
	<div id="about" ref="about" class="grid-container">
		...
		<p>I've spent the last decade of my career exploring visual communication, learning about the intracacies that technology has to offer and exploring what user experience is and applying it in the real world.
		<br>
		<br>
